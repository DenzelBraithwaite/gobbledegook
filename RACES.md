...
![The Emperor doubling a mixed hand's Human score](./readme_assets/readme_emperor_human_legendary_buff.png)
...
![A close-up of the Void Runner](./readme_assets/readme_void_runner_cloesup.png)
...
![Brite revealed to the other player while the remaining cards stay hidden](./readme_assets/readme_brite_other_client.png)
