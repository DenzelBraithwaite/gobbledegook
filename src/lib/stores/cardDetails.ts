...
const cardDetails = writable({
  ...
  emperor: {
    ...
    trait: 'Doubles Human points, including Commander bonuses, then adds printed base points from non-Human, non-Xeno cards. Other-race bonuses do not carry over.',
  ...
  ai: {
    ...
    trait: 'ALL bots will receive +4 points, turning viruses into positive points. Additionally, A.I. will hack all bots and steal their points.',
  ...
  protectron: {
    ...
    trait: 'Real Viruses gain +8 once, even with multiple Protectrons. Each Protectron also gains +1 for every Virus or Leon; Leon does not gain the +8.',
  ...
  dreamDestroyer: {
    ...
    trait: 'All of your beasts\' base points are increased to 18 points.',
  ...
  vulture: {
    ...
    rarity: 'great',
    traitTitle: 'Scraps',
    trait: 'When drawn, your next draw cannot be a Beast.If only Beasts remain, draw one normally.',
  ...
  duck: {
    ...
    traitTitle: '',
    trait: '',
    description: "One hell of a duck. The OG quacker.",
    race: 'beast',
    otherRaces: [],
  ...
  nightTerror: {
    ...
    trait: 'All of your beasts\' base points are increased to 15 points.',
  ...
  oreoCookie: {
    ...
    rarity: 'great',
    traitTitle: 'Snack',
    trait: 'When drawn player gains +5(doubled for bots, doesn\'t work on spirits) points to all races even after this card is discarded.',
    description: 'A cookie dropped by someone or something.',
    race: 'boost',
    otherRaces: [],
    image: '/boosts/oreo_cookie.png'
  },
  chocoChipCookie: {
    ...
    race: 'boost',
    otherRaces: [],
    image: '/boosts/choco_chip_cookie.png'
  },
  thumbprintCookie: {
    title: 'thumbprintCookie',
    displayTitle: 'Cookie',
    points: 0,
    amount: 1,
    rarity: 'great',
    ...
    race: 'boost',
    otherRaces: [],
    image: '/boosts/thumbprint_cookie.png'
  },
  oatmealCookie: {
    title: 'oatmealCookie',
    displayTitle: 'Cookie',
    ...
    race: 'boost',
    otherRaces: [],
    image: '/boosts/oatmeal_cookie.png'
  },
  cookieCrumbs: {
    title: 'cookieCrumbs',
    displayTitle: 'Cookie Crumbs',
    points: 0,
    amount: 4,
    rarity: 'poor',
    traitTitle: 'Light Snack',
    trait: 'When drawn player gains +3(doubled for bots, doesn\'t work on spirits) points to all races even after this card is discarded.',
    description: 'Crumbs from a cookie someone or something was eating.',
    race: 'boost',
    otherRaces: [],
    image: '/boosts/cookie_crumbs.png'
  },
  feast: {
    title: 'feast',
    displayTitle: 'Feast',
  ...
  chjester: {
    ...
    rarity: 'epic',
    traitTitle: 'Surprise',
    trait: 'If your hand contains a legendary (excludes boosts/traps/neutrals), discarding this card will instead discard the legendary (chosen at random if multiple). Cannot be found if player is protected from traps.',
  ...
  rottenCookieCrumbs: {
    title: 'rottenCookieCrumbs',
    displayTitle: 'Rotten Crumbs',
    points: 0,
    amount: 4,
    rarity: 'poor',
    traitTitle: 'Bad Snack',
    trait: 'When drawn player loses 3 points(bots and spirits immune) towards every race even after this card is discarded.',
    description: 'Stale crumbs that were dropped and long since forgotten.',
    race: 'trap',
    otherRaces: [],
    image: '/traps/rotten_cookie_crumbs.png'
  },
  xenophobia: {
    title: 'xenophobia',
